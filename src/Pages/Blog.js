...
function Blog() {
  return (
    <div>
      <ComonSecation title="BLOG"></ComonSecation>
            ...
            <div className='col-lg-4 col-md-6 col-sm-6 col-12'>
              <div class="card" style={{width:"23rem"}}>
                <img src="Assets/img/s1.jpg" class="card-img-top" alt="..."/>
                  <div class="card-body">
                    <h4 class="card-title">Live With Music</h4>
                    <h6 className='text-danger'>March 20 <span className='ms-3'> Comment</span></h6>
            ...
            <div className='col-lg-4 col-md-6 col-sm-6 col-12'>
              <div class="card" style={{width:"23rem"}}>
                <img src="Assets/img/s2.jpg" class="card-img-top" alt="..."/>
                  <div class="card-body">
                    <h4 class="card-title">Best Music</h4>
                    <h6 className='text-danger'>March 20 <span className='ms-3'> Comment</span></h6>
                    <p class="card-text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters,</p>
                  </div>
              </div>
