        ...
        <div className='container '>
          <div className='row'>
            <div className='col-lg-6 col-md-6 col-sm-6 col-5 '>
              <div>
                <img src='Assets/img/logo.jpg' alt='' className='img-fluid '></img>
              </div>
            </div>
              ...
              <div className='float-end position-relative '>
                ...
                <div className="offcanvas offcanvas-end" data-bs-backdrop="static" tabIndex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel">
                  <div className="offcanvas-header">
                    <img src='https://themewagon.github.io/lighten/images/logo.jpg' alt='' className='w-50'></img>
                  ...
                  <div className="offcanvas-body">
                    <div>
                      {
                        pro.length === 0?(
                          <img src='https://cdni.iconscout.com/illustration/free/thumb/free-empty-cart-4085814-3385483.png' className='w-50 d-block mx-auto mt-5' alt=""></img>
                        ):pro.map((item) => {
                          return <Cart items={item}></Cart>
                        })
                      }
                ...
                <span className='fs-4 ms-3'><i className="fa-solid fa-bars mt-4" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
